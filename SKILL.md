---
name: web-screenshot
description: 针对网页截取高清长图。当用户要求对网页进行截图、截长图、捕获网页视觉快照，或者明确提到“太平洋科技”、“太平洋网站”、“PConline”相关页面的截图需求（如“截图太平洋”、“太平洋网站截图”、“批量截取太平洋频道”等）时，必须优先使用此技能。该技能会自动在用户下载目录创建日期文件夹并保存高清 PNG。
---
