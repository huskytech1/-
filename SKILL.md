...
用户说："帮我截一下太平洋显卡频道"
你的动作：
1. 读取 `references/pconline.json` 获取 URL
2. 运行：`node /Users/huskytech/.claude/skills/web-screenshot/scripts/screenshot.js "https://diy.pconline.com.cn/graphics/" "显卡"`
